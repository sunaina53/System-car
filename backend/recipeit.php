				...
				<div class="grid invoice">
					<div class="grid-body">
						...
						<div class="row">
							<div class="col-xs-6">
								<address>
									<strong>ชื่อลูกค้า : คุณ</strong><br>
						...
						<div class="row">
							<div class="col-xs-6">
								<address>
									<strong>วันที่ต้องการรับสินค้า:</strong><br>
								...
								<table class="table table-striped">
									...
									<tbody>
										...
										?>
											<tr>
												<td><?php echo $i ?></td>
												<td><strong><?php echo $sp_name ?></strong><br><?php echo $sp_detail ?>&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;</td>
